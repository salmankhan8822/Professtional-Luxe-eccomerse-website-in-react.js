        ...
        {cartItems.length === 0 ? (
          ...
          <div className="cart-page-layout">
              ...
              {cartItems.map((item) => (
                <div className="cart-page-item" key={item.id}>
                  ...
                  <div className="cart-page-product-info">
                    ...
                    <h3>{item.name}</h3>
                    <p className="cart-page-price">Rs. {item.price.toLocaleString()}</p>
            ...
            <aside className="cart-page-summary">
              ...
              <button type="button" className="cart-page-checkout" onClick={() =>
                  alert("Checkout page coming soon")}>CHECKOUT</button>
